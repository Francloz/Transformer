...
from jadore_utils.apply_bpe import BPE
from jadore_utils.learn_bpe import learn_bpe
...
_TRAIN_DATA_SOURCES = [
    {"url": "http://statmt.org/wmt14/training-parallel-nc-v9.tgz",
     "trg": "news-commentary-v9.fr-en.en",
     "src": "news-commentary-v9.fr-en.fr"},
    {"url": "http://statmt.org/wmt13/training-parallel-commoncrawl.tgz",
     "trg": "commoncrawl.fr-en.en",
     "src": "commoncrawl.fr-en.fr"},
    {"url": "http://statmt.org/wmt13/training-parallel-europarl-v7.tgz",
     "trg": "europarl-v7.fr-en.en",
     "src": "europarl-v7.fr-en.fr"},
    {"url": "http://statmt.org/wmt10/training-giga-fren.tar",
     "trg": "giga-fren.release2.fixed.en",
     "src": "giga-fren.release2.fixed.fr"},
    {"url": "http://statmt.org/wmt13/training-parallel-un.tgz",
     "trg": "undoc.2000.fr-en.en",
     "src": "undoc.2000.fr-en.fr"}
]
...
def encode_file(bpe, in_file, out_file):
    if os.path.isfile(out_file):
        sys.stderr.write(f"Skipping writing already existing encoded file: {out_file}\n")
        return
...
def main_wo_bpe():
    '''
    Usage: python data.py -lang_src de -lang_trg en -save_data multi30k_de_en.pkl -share_vocab
    '''
